...
def get_params():
    ...
    args.add_argument("-path", "--data_path", default="./data/Task/", type=str)  # ["./NELL", "./Wiki"]
    ...
    args.add_argument("-epo", "--epoch", default=300000, type=int)
...
data_dir = {
    ...
    'dev_tasks' : 'test_support.json',
    'test_support': 'test_support.json',
    'test_query': 'test_query.json',
    'test_gt': 'groundtruth.csv',
    ...
    'ent2vec': 'entity2vec.csv',
    'rel2vec': 'relation2vec.csv',
